...
{capture name=path}
		...
		<span class="navigation-pipe"></span>{l s='Search' mod='xenforum'} "{$key|escape:'htmlall':'UTF-8'}"
{/capture}

<div id="blogview" class="blogview">
	<div class='blog_title'>{l s='Search results for' mod='xenforum'} "{$key|escape:'htmlall':'UTF-8'}":</div>
<!-- Show forums and topics -->
{if $allposts == ''}
	<p class="error">({l s='No results!' mod='xenforum'})</p>
{else}
