...
class XenForumTagsModuleFrontController extends XenForumModuleFrontController
{
    public $ssl = true;
    ...
    public function getBreadcrumbLinks()
    {
        ...
        $breadcrumb['links'][] = array(
            'title' => sprintf($this->l('Tag: %s'), Tools::getvalue('tags', false)),
            'url' => null,
        );
        return $breadcrumb;
    }
    ...
    public function initContent()
    {
        ...
        if ($tags = Tools::getvalue('tags', false)) {
            $tags = str_replace('+', ' ', $tags);
            $total = $blog->getToltalByTag($tags);
        }
        ...
        if ($tags) {
            $allposts = $blog->getTopicByTag($limit_start, $limit, $tags, $this->context->customer->id);
        ...
        if (version_compare(_PS_VERSION_, '1.7.0.0 ', '>=')) {
            $this->setTemplate('module:xenforum/views/templates/front/ps17-tags.tpl');
        } else {
